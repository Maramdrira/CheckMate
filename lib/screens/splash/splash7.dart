...
class _Splash7State extends State<Splash7> with SingleTickerProviderStateMixin {
    ...
    return Scaffold(
      body: Stack(
        ...
        children: [
          // Background image
          Image.asset(
            'assets/images/splash7.jpg', // Make sure to add this image to your assets
            fit: BoxFit.cover,
          ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ShaderMask(
                        ...
                        child: const Text(
                          ...
                          style: TextStyle(
                            ...
                            letterSpacing: 1.2,
                            color: Color.fromARGB(216, 151, 12, 194),
                          ),
                        ),
                      ),
                      ...
                      const Icon(Icons.auto_awesome,
                          size: 16, color: Color.fromARGB(216, 151, 12, 194)),
                    ],
                  ),
                ),
              ),
