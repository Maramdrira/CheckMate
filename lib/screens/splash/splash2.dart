...
class _Splash2State extends State<Splash2> with SingleTickerProviderStateMixin {
  ...
  final String asset = 'assets/videos/splash2.mp4';
  final Duration showTime = const Duration(seconds: 2, milliseconds: 200);
      ...
      return Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
            colors: [Colors.blue.shade800, Colors.tealAccent.shade400],
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  ...
                  Colors.tealAccent.shade400.withOpacity(.15)
                ],
                begin: Alignment.topLeft,
                end: Alignment.bottomRight,
              ),
