...
class _Splash4State extends State<Splash4> with SingleTickerProviderStateMixin {
  ...
  final String asset = 'assets/videos/splash4.mp4';
  final Duration showTime = const Duration(
      seconds: 3, microseconds: 600); // ← put your video length here
        ...
        children: [
          ...
          Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  Colors.orange.shade800.withOpacity(.25),
                  Colors.amber.shade600.withOpacity(.15)
                ],
                begin: Alignment.topLeft,
                end: Alignment.bottomRight,
              ),
