...
class Splash10 extends StatefulWidget {
  const Splash10({super.key});

  @override
  State<Splash10> createState() => _Splash10State();
}

class _Splash10State extends State<Splash10> with SingleTickerProviderStateMixin {
    ...
    return Scaffold(
      body: Stack(
        ...
        children: [
          // Background image
          Image.asset(
            'assets/images/splash10.jpg', // Make sure to add this image to your assets
            fit: BoxFit.cover,
          ),
