...
class Splash8 extends StatefulWidget {
  ...
  @override
  State<Splash8> createState() => _Splash8State();
}

class _Splash8State extends State<Splash8> with SingleTickerProviderStateMixin {
    ...
    return Scaffold(
      body: Stack(
        ...
        children: [
          // Background image
          Image.asset(
            'assets/images/splash8.jpg', // Make sure to add this image to your assets
            fit: BoxFit.cover,
          ),
